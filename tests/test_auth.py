...
test_auth.py
------------
Tests for auth.py: account creation, PIN lockout after 3 failed
attempts, and admin login. File writes are patched out so tests never
touch the real atm_database.json.
"""
...
class TestCreateAccount(unittest.TestCase):
    @patch("auth.save_db")  # don't touch disk
